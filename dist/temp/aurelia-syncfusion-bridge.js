...
exports.Ej2Uploader = exports.ej2Tooltip = exports.Ej2Toolbar = exports.Ej2Items = exports.ej2Toast = exports.Ej2TimePicker = exports.Ej2TextBox = exports.ej2Tab = exports.Ej2Switch = exports.Ej2Splitter = exports.ej2SplitButton = exports.Ej2Slider = exports.ej2Sidebar = exports.ej2Schedule = exports.ej2Rte = exports.Ej2RadioButton = exports.ej2ProgressButton = exports.ej2PdfViewer = exports.ej2Overview = exports.Ej2NumericTextBox = exports.Ej2MultiSelect = exports.ej2Menu = exports.ej2MaskEdit = exports.ej2ListView = exports.Ej2ListBox = exports.ej2LinearGauge = exports.Ej2Grid = exports.Ej2Column = exports.Ej2DropDownList = exports.ej2DropDownButton = exports.ej2Dialog = exports.ej2Diagram = exports.ej2DateTimePicker = exports.ej2DateRangePicker = exports.Ej2DatePicker = exports.Ej2DashboardLayout = exports.ej2ContextMenu = exports.Ej2ComboBox = exports.Ej2ColorPicker = exports.Chips = exports.ej2ChipList = exports.Ej2CheckBox = exports.SeriesVM = exports.ej2Chart = exports.Ej2Calendar = exports.ej2Button = exports.Ej2AutoComplete = exports.Ej2Accordion = exports.ejWaitingPopup = exports.ejUploadbox = exports.ejTreeView = undefined;
...
var _ej2Layouts = require('@syncfusion/ej2-layouts');
...
var _ej2Lists = require('@syncfusion/ej2-lists');
...
var _ej2Notifications = require('@syncfusion/ej2-notifications');
    ...
    Ej2WidgetBase.prototype.createWidget = function createWidget(option) {
        ...
        if (this.isEditor || this.controlName == constants.ej2ElementPrefix + 'RTE') {
            this.widget.change = function (arg) {
                if (_this13.controlName == constants.ej2ElementPrefix + 'RTE' && arg && arg.element && 'eValue' in _this13) _this13[_this13.util.getBindablePropertyName('value')] = arg.element.value;else if (_this13.controlName == constants.ej2ElementPrefix + 'Switch' && arg) _this13[_this13.util.getBindablePropertyName('checked')] = arg.checked;else if (_this13.controlName == constants.ej2ElementPrefix + 'DateRangePicker' && arg) {
                    _this13[_this13.util.getBindablePropertyName('value')] = arg.value;
                    _this13[_this13.util.getBindablePropertyName('startDate')] = arg.startDate;
                    _this13[_this13.util.getBindablePropertyName('endDate')] = arg.endDate;
                } else if (arg && 'eValue' in _this13) _this13[_this13.util.getBindablePropertyName('value')] = arg.value;
            };
        }
    };
...
var ejCurrencyTextbox = function (_WidgetBase11) {
...
var ejDatePicker = function (_WidgetBase12) {
...
var ejGrid = function (_WidgetBase21) {
...
var ejGroupButton = function (_WidgetBase22) {
...
var ejOverview = function (_WidgetBase34) {
...
var ejPager = function (_WidgetBase35) {
...
var ejRte = function (_WidgetBase52) {
...
var ejSchedule = function (_WidgetBase53) {
    ...
    function ejSchedule(element) {
        ...
        _this63.childPropertyName = 'resources';
        return _this63;
    }
...
var Ej2AutoComplete = function (_Ej2WidgetBase2) {
    _inherits(Ej2AutoComplete, _Ej2WidgetBase2);

    function Ej2AutoComplete(element) {
        _classCallCheck(this, Ej2AutoComplete);

        var _this87 = _possibleConstructorReturn(this, _Ej2WidgetBase2.call(this, _ej2Dropdowns.AutoComplete));

        _this87.isEditor = true;
        _this87.element = element;
        return _this87;
    }

    return Ej2AutoComplete;
}(Ej2WidgetBase);
exports.Ej2AutoComplete = Ej2AutoComplete = __decorate([(0, _aureliaTemplating.customElement)(constants.ej2AttributePrefix + 'auto-complete'), (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), generateBindables(constants.ej2ElementPrefix + 'AutoComplete', ['actionFailureTemplate', 'allowCustom', 'allowFiltering', 'autofill', 'cssClass', 'dataSource', 'enablePersistence', 'enableRtl', 'enabled', 'fields', 'filterBarPlaceholder', 'filterType', 'floatLabelType', 'footerTemplate', 'groupTemplate', 'headerTemplate', 'highlight', 'htmlAttributes', 'ignoreAccent', 'ignoreCase', 'index', 'itemTemplate', 'locale', 'minLength', 'noRecordsTemplate', 'placeholder', 'popupHeight', 'popupWidth', 'query', 'readonly', 'showClearButton', 'showPopupButton', 'sortOrder', 'suggestionCount', 'text', 'value', 'valueTemplate', 'width', 'zIndex'], ['value'], null, null), (0, _aureliaDependencyInjection.inject)(Element)], Ej2AutoComplete);
...
var ej2Button = function (_Ej2WidgetBase3) {
    _inherits(ej2Button, _Ej2WidgetBase3);

    function ej2Button(element) {
        _classCallCheck(this, ej2Button);

        var _this88 = _possibleConstructorReturn(this, _Ej2WidgetBase3.call(this, _ej2Buttons.Button));
...
exports.ej2Button = ej2Button = __decorate([(0, _aureliaTemplating.customAttribute)(constants.ej2AttributePrefix + 'button'), generateBindables(constants.ej2AttributePrefix + 'Button', ['content', 'cssClass', 'disabled', 'enableHtmlSanitizer', 'enablePersistence', 'enableRtl', 'iconCss', 'iconPosition', 'isPrimary', 'isToggle', 'locale'], [], null, null), (0, _aureliaDependencyInjection.inject)(Element)], ej2Button);
...
var Ej2Calendar = function (_Ej2WidgetBase4) {
    _inherits(Ej2Calendar, _Ej2WidgetBase4);

    function Ej2Calendar(element) {
        _classCallCheck(this, Ej2Calendar);

        var _this89 = _possibleConstructorReturn(this, _Ej2WidgetBase4.call(this, _ej2Calendars.Calendar));
...
exports.Ej2Calendar = Ej2Calendar = __decorate([(0, _aureliaTemplating.customElement)(constants.ej2AttributePrefix + 'calendar'), (0, _aureliaTemplating.inlineView)("<template><div></div></template>"), generateBindables(constants.ej2ElementPrefix + 'Calendar', ['calendarMode', 'dayHeaderFormat', 'depth', 'enablePersistence', 'enableRtl', 'firstDayOfWeek', 'isMultiSelection', 'keyConfigs', 'locale', 'max', 'min', 'serverTimezoneOffset', 'showTodayButton', 'start', 'value', 'values', 'weekNumber'], ['value', 'values'], null, null), (0, _aureliaDependencyInjection.inject)(Element)], Ej2Calendar);
...
var ej2Chart = function (_Ej2WidgetBase5) {
    _inherits(ej2Chart, _Ej2WidgetBase5);

    function ej2Chart(element) {
        _classCallCheck(this, ej2Chart);

        var _this90 = _possibleConstructorReturn(this, _Ej2WidgetBase5.call(this, _ej2Charts.Chart));

        _this90.series = [];
        _this90.element = element;
        _this90.hasChildProperty = true;
        _this90.childPropertyName = 'series';
        return _this90;
    }
...
var Ej2CheckBox = function (_Ej2WidgetBase6) {
    _inherits(Ej2CheckBox, _Ej2WidgetBase6);

    function Ej2CheckBox(element) {
        _classCallCheck(this, Ej2CheckBox);

        var _this91 = _possibleConstructorReturn(this, _Ej2WidgetBase6.call(this, _ej2Buttons.CheckBox));

        _this91.isEditor = true;
...
exports.Ej2CheckBox = Ej2CheckBox = __decorate([(0, _aureliaTemplating.customAttribute)(constants.ej2AttributePrefix + 'check-box'), generateBindables(constants.ej2ElementPrefix + 'CheckBox', ['checked', 'cssClass', 'disabled', 'enablePersistence', 'enableRtl', 'htmlAttributes', 'indeterminate', 'label', 'labelPosition', 'locale', 'name', 'value'], ['checked', 'indeterminate'], null, null), (0, _aureliaDependencyInjection.inject)(Element)], Ej2CheckBox);
...
var ej2ChipList = function (_Ej2WidgetBase7) {
    _inherits(ej2ChipList, _Ej2WidgetBase7);

    function ej2ChipList(element) {
        _classCallCheck(this, ej2ChipList);

        var _this92 = _possibleConstructorReturn(this, _Ej2WidgetBase7.call(this, _ej2Buttons.ChipList));

        _this92.chips = [];
        _this92.element = element;
        _this92.hasChildProperty = true;
        _this92.childPropertyName = 'chips';
        return _this92;
    }

    return ej2ChipList;
}(Ej2WidgetBase);
__decorate([(0, _aureliaTemplating.children)('e-chips')], ej2ChipList.prototype, "chips", void 0);
exports.ej2ChipList = ej2ChipList = __decorate([(0, _aureliaTemplating.customElement)(constants.ej2ElementPrefix + 'chip-list'), (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), generateBindables(constants.ej2ElementPrefix + 'ChipList', ['avatarIconCss', 'avatarText', 'chips', 'cssClass', 'enableDelete', 'enablePersistence', 'enableRtl', 'enabled', 'leadingIconCss', 'locale', 'selectedChips', 'selection', 'text', 'trailingIconCss'], [], [], null), (0, _aureliaDependencyInjection.inject)(Element)], ej2ChipList);
...
exports.Chips = Chips = __decorate([(0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), (0, _aureliaTemplating.customElement)('e-chip'), generateBindables('chips', ['avatarIconCss', 'avatarText', 'cssClass', 'enabled', 'leadingIconCss', 'text', 'trailingIconCss'], [], null, null)], Chips);
exports.Chips = Chips;
...
var Ej2ColorPicker = function (_Ej2WidgetBase8) {
    _inherits(Ej2ColorPicker, _Ej2WidgetBase8);

    function Ej2ColorPicker(element) {
        _classCallCheck(this, Ej2ColorPicker);

        var _this93 = _possibleConstructorReturn(this, _Ej2WidgetBase8.call(this, _ej2Inputs.ColorPicker));

        _this93.isEditor = true;
...
exports.Ej2ColorPicker = Ej2ColorPicker = __decorate([(0, _aureliaTemplating.customAttribute)(constants.ej2AttributePrefix + 'color-picker'), generateBindables(constants.ej2ElementPrefix + 'ColorPicker', ['columns', 'cssClass', 'disabled', 'enableOpacity', 'enablePersistence', 'enableRtl', 'inline', 'locale', 'mode', 'modeSwitcher', 'noColor', 'presetColors', 'showButtons', 'value'], ['value'], null, null), (0, _aureliaDependencyInjection.inject)(Element)], Ej2ColorPicker);
...
var Ej2ComboBox = function (_Ej2WidgetBase9) {
    _inherits(Ej2ComboBox, _Ej2WidgetBase9);

    function Ej2ComboBox(element) {
        _classCallCheck(this, Ej2ComboBox);

        var _this94 = _possibleConstructorReturn(this, _Ej2WidgetBase9.call(this, _ej2Dropdowns.ComboBox));

        _this94.isEditor = true;
...
exports.Ej2ComboBox = Ej2ComboBox = __decorate([(0, _aureliaTemplating.customAttribute)(constants.ej2AttributePrefix + 'combo-box'), generateBindables(constants.ej2ElementPrefix + 'ComboBox', ['actionFailureTemplate', 'allowCustom', 'allowFiltering', 'autofill', 'cssClass', 'dataSource', 'enablePersistence', 'enableRtl', 'enabled', 'fields', 'filterBarPlaceholder', 'filterType', 'floatLabelType', 'footerTemplate', 'groupTemplate', 'headerTemplate', 'htmlAttributes', 'ignoreAccent', 'ignoreCase', 'index', 'itemTemplate', 'locale', 'noRecordsTemplate', 'placeholder', 'popupHeight', 'popupWidth', 'query', 'readonly', 'showClearButton', 'sortOrder', 'text', 'value', 'valueTemplate', 'width', 'zIndex'], ['value'], null, null), (0, _aureliaDependencyInjection.inject)(Element)], Ej2ComboBox);
...
var ej2ContextMenu = function (_Ej2WidgetBase10) {
    _inherits(ej2ContextMenu, _Ej2WidgetBase10);

    function ej2ContextMenu(element) {
        _classCallCheck(this, ej2ContextMenu);

        var _this95 = _possibleConstructorReturn(this, _Ej2WidgetBase10.call(this, _ej2Navigations.ContextMenu));
...
exports.ej2ContextMenu = ej2ContextMenu = __decorate([(0, _aureliaTemplating.customElement)(constants.ej2ElementPrefix + 'context-menu'), (0, _aureliaTemplating.inlineView)("<template><ul></ul></template>"), generateBindables(constants.ej2ElementPrefix + 'ContextMenu', ['animationSettings', 'cssClass', 'enableHtmlSanitizer', 'enablePersistence', 'enableRtl', 'enableScrolling', 'fields', 'filter', 'items', 'locale', 'showItemOnClick', 'target', 'template'], [], null, null), (0, _aureliaDependencyInjection.inject)(Element)], ej2ContextMenu);
exports.ej2ContextMenu = ej2ContextMenu;
...
var Ej2DashboardLayout = function (_Ej2WidgetBase11) {
    _inherits(Ej2DashboardLayout, _Ej2WidgetBase11);

    function Ej2DashboardLayout(element) {
        _classCallCheck(this, Ej2DashboardLayout);

        var _this96 = _possibleConstructorReturn(this, _Ej2WidgetBase11.call(this, _ej2Layouts.DashboardLayout));
...
exports.Ej2DashboardLayout = Ej2DashboardLayout = __decorate([(0, _aureliaTemplating.customElement)(constants.ej2ElementPrefix + 'dashboard-layout'), (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), generateBindables(constants.ej2ElementPrefix + 'DashboardLayout ', ['allowDragging', 'allowFloating', 'allowPushing', 'allowResizing', 'cellAspectRatio', 'cellSpacing', 'columns', 'draggableHandle', 'enableHtmlSanitizer', 'enablePersistence', 'enableRtl', 'locale', 'mediaQuery', 'panels', 'resizableHandles', 'showGridLines'], [], null, null), (0, _aureliaDependencyInjection.inject)(Element)], Ej2DashboardLayout);
...
var Ej2DatePicker = function (_Ej2WidgetBase12) {
    _inherits(Ej2DatePicker, _Ej2WidgetBase12);

    function Ej2DatePicker(element) {
        _classCallCheck(this, Ej2DatePicker);

        var _this97 = _possibleConstructorReturn(this, _Ej2WidgetBase12.call(this, _ej2Calendars.DatePicker));

        _this97.isEditor = true;
        _this97.element = element;
        return _this97;
    }
...
var ej2DateRangePicker = function (_Ej2WidgetBase13) {
    _inherits(ej2DateRangePicker, _Ej2WidgetBase13);

    function ej2DateRangePicker(element) {
        _classCallCheck(this, ej2DateRangePicker);

        var _this98 = _possibleConstructorReturn(this, _Ej2WidgetBase13.call(this, _ej2Calendars.DateRangePicker));

        _this98.isEditor = true;
        _this98.element = element;
        return _this98;
    }

    return ej2DateRangePicker;
}(Ej2WidgetBase);
exports.ej2DateRangePicker = ej2DateRangePicker = __decorate([(0, _aureliaTemplating.customAttribute)(constants.ej2AttributePrefix + 'date-range-picker'), generateBindables(constants.ej2ElementPrefix + 'DateRangePicker', ['allowEdit', 'calendarMode', 'cssClass', 'dayHeaderFormat', 'depth', 'enablePersistence', 'enableRtl', 'enabled', 'endDate', 'firstDayOfWeek', 'floatLabelType', 'format', 'htmlAttributes', 'keyConfigs', 'locale', 'max', 'maxDays', 'min', 'minDays', 'placeholder', 'presets', 'readonly', 'separator', 'serverTimezoneOffset', 'showClearButton', 'start', 'startDate', 'strictMode', 'value', 'weekNumber', 'width', 'zIndex'], ['startDate', 'endDate', 'value'], null, null), (0, _aureliaDependencyInjection.inject)(Element)], ej2DateRangePicker);
exports.ej2DateRangePicker = ej2DateRangePicker;
...
var ej2DateTimePicker = function (_Ej2WidgetBase14) {
    _inherits(ej2DateTimePicker, _Ej2WidgetBase14);

    function ej2DateTimePicker(element) {
        _classCallCheck(this, ej2DateTimePicker);

        var _this99 = _possibleConstructorReturn(this, _Ej2WidgetBase14.call(this, _ej2Calendars.DateTimePicker));

        _this99.isEditor = true;
        _this99.element = element;
        return _this99;
    }
...
var ej2Diagram = function (_Ej2WidgetBase15) {
    _inherits(ej2Diagram, _Ej2WidgetBase15);

    function ej2Diagram(element) {
        _classCallCheck(this, ej2Diagram);

        var _this100 = _possibleConstructorReturn(this, _Ej2WidgetBase15.call(this, _ej2Diagrams.Diagram));

        _this100.element = element;
        return _this100;
    }
...
var ej2Dialog = function (_Ej2WidgetBase16) {
    _inherits(ej2Dialog, _Ej2WidgetBase16);

    function ej2Dialog(element) {
        _classCallCheck(this, ej2Dialog);

        var _this101 = _possibleConstructorReturn(this, _Ej2WidgetBase16.call(this, _ej2Popups.Dialog));
...
exports.ej2Dialog = ej2Dialog = __decorate([(0, _aureliaTemplating.customElement)(constants.ej2ElementPrefix + 'dialog'), (0, _aureliaTemplating.inlineView)(constants.aureliaTemplateString), generateBindables(constants.ej2ElementPrefix + 'Dialog', ['allowDragging', 'animationSettings', 'buttons', 'closeOnEscape', 'content', 'cssClass', 'enableHtmlSanitizer', 'enablePersistence', 'enableResize', 'enableRtl', 'footerTemplate', 'header', 'height', 'isModal', 'locale', 'minHeight', 'position', 'showCloseIcon', 'target', 'visible', 'width', 'zIndex'], ['visible'], null, null), (0, _aureliaDependencyInjection.inject)(Element)], ej2Dialog);
...
var ej2DropDownButton = function (_Ej2WidgetBase17) {
    _inherits(ej2DropDownButton, _Ej2WidgetBase17);

    function ej2DropDownButton(element) {
        _classCallCheck(this, ej2DropDownButton);

        var _this102 = _possibleConstructorReturn(this, _Ej2WidgetBase17.call(this, _ej2Splitbuttons.DropDownButton));
...
exports.ej2DropDownButton = ej2DropDownButton = __decorate([(0, _aureliaTemplating.customAttribute)(constants.ej2AttributePrefix + 'drop-down-button'), generateBindables(constants.ej2ElementPrefix + 'DropDownButton', ['content', 'cssClass', 'disabled', 'enableHtmlSanitizer', 'enablePersistence', 'enableRtl', 'iconCss', 'iconPosition', 'items', 'locale', 'target'], [], null, null), (0, _aureliaDependencyInjection.inject)(Element)], ej2DropDownButton);
...
var Ej2DropDownList = function (_Ej2WidgetBase18) {
    _inherits(Ej2DropDownList, _Ej2WidgetBase18);

    function Ej2DropDownList(element) {
        _classCallCheck(this, Ej2DropDownList);

        var _this103 = _possibleConstructorReturn(this, _Ej2WidgetBase18.call(this, _ej2Dropdowns.DropDownList));

        _this103.isEditor = true;
...
exports.Ej2DropDownList = Ej2DropDownList = __decorate([(0, _aureliaTemplating.customAttribute)(constants.ej2AttributePrefix + 'drop-down-list'), generateBindables(constants.ej2ElementPrefix + 'DropDownList', ['actionFailureTemplate', 'allowFiltering', 'cssClass', 'dataSource', 'enablePersistence', 'enableRtl', 'enabled', 'fields', 'filterBarPlaceholder', 'filterType', 'floatLabelType', 'footerTemplate', 'groupTemplate', 'headerTemplate', 'htmlAttributes', 'ignoreAccent', 'ignoreCase', 'index', 'itemTemplate', 'locale', 'noRecordsTemplate', 'placeholder', 'popupHeight', 'popupWidth', 'query', 'readonly', 'showClearButton', 'sortOrder', 'text', 'value', 'valueTemplate', 'width', 'zIndex'], ['value'], null, null), (0, _aureliaDependencyInjection.inject)(Element)], Ej2DropDownList);
...
var Ej2Grid = function (_Ej2WidgetBase19) {
    _inherits(Ej2Grid, _Ej2WidgetBase19);

    function Ej2Grid(element, templateEngine) {
        _classCallCheck(this, Ej2Grid);

        var _this104 = _possibleConstructorReturn(this, _Ej2WidgetBase19.call(this, _ej2Grids.Grid));

        _this104.columns = [];
        _this104.element = element;
        _this104.hasChildProperty = true;
        _this104.childPropertyName = 'columns';
        _this104.templateProcessor = new Ej2TemplateProcessor(_this104, templateEngine);
        return _this104;
    }
...
var ej2LinearGauge = function (_Ej2WidgetBase20) {
    _inherits(ej2LinearGauge, _Ej2WidgetBase20);

    function ej2LinearGauge(element) {
        _classCallCheck(this, ej2LinearGauge);

        var _this105 = _possibleConstructorReturn(this, _Ej2WidgetBase20.call(this, _ej2Lineargauge.LinearGauge));
...
_ej2Dropdowns.ListBox.Inject(_ej2Dropdowns.CheckBoxSelection);
var Ej2ListBox = function (_Ej2WidgetBase21) {
    _inherits(Ej2ListBox, _Ej2WidgetBase21);

    function Ej2ListBox(element) {
        _classCallCheck(this, Ej2ListBox);

        var _this106 = _possibleConstructorReturn(this, _Ej2WidgetBase21.call(this, _ej2Dropdowns.ListBox));

        _this106.isEditor = true;
...
exports.Ej2ListBox = Ej2ListBox = __decorate([(0, _aureliaTemplating.customAttribute)(constants.ej2AttributePrefix + 'list-box'), generateBindables(constants.ej2ElementPrefix + 'ListBox', ['actionFailureTemplate', 'allowDragAndDrop', 'allowFiltering', 'cssClass', 'dataSource', 'enablePersistence', 'enableRtl', 'enabled', 'fields', 'filterType', 'groupTemplate', 'height', 'ignoreAccent', 'ignoreCase', 'itemTemplate', 'locale', 'maximumSelectionLength', 'noRecordsTemplate', 'query', 'scope', 'selectionSettings', 'sortOrder', 'toolbarSettings', 'value', 'zIndex'], ['value'], null, null), (0, _aureliaDependencyInjection.inject)(Element)], Ej2ListBox);
exports.Ej2ListBox = Ej2ListBox;
...
var ej2ListView = function (_Ej2WidgetBase22) {
    _inherits(ej2ListView, _Ej2WidgetBase22);

    function ej2ListView(element) {
        _classCallCheck(this, ej2ListView);

        var _this107 = _possibleConstructorReturn(this, _Ej2WidgetBase22.call(this, _ej2Lists.ListView));
...
exports.ej2ListView = ej2ListView = __decorate([(0, _aureliaTemplating.customElement)(constants.ej2ElementPrefix + 'list-view'), (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), generateBindables(constants.ej2ElementPrefix + 'ListView', ['animation', 'checkBoxPosition', 'cssClass', 'dataSource', 'enable', 'enableHtmlSanitizer', 'enablePersistence', 'enableRtl', 'enableVirtualization', 'fields', 'groupTemplate', 'headerTemplate', 'headerTitle', 'height', 'htmlAttributes', 'locale', 'query', 'showCheckBox', 'showHeader', 'showIcon', 'sortOrder', 'template', 'width'], [], [], null), (0, _aureliaDependencyInjection.inject)(Element)], ej2ListView);
...
var ej2MaskEdit = function (_Ej2WidgetBase23) {
    _inherits(ej2MaskEdit, _Ej2WidgetBase23);

    function ej2MaskEdit(element) {
        _classCallCheck(this, ej2MaskEdit);

        var _this108 = _possibleConstructorReturn(this, _Ej2WidgetBase23.call(this, _ej2Inputs.MaskedTextBox));
...
exports.ej2MaskEdit = ej2MaskEdit = __decorate([(0, _aureliaTemplating.customAttribute)(constants.ej2AttributePrefix + 'mask-edit'), generateBindables(constants.ej2AttributePrefix + 'MaskEdit', ['cssClass', 'customCharacters', 'enablePersistence', 'enableRtl', 'enabled', 'floatLabelType', 'htmlAttributes', 'locale', 'mask', 'placeholder', 'promptChar', 'readonly', 'showClearButton', 'value', 'width'], ['value'], [], null), (0, _aureliaDependencyInjection.inject)(Element)], ej2MaskEdit);
...
var ej2Menu = function (_Ej2WidgetBase24) {
    _inherits(ej2Menu, _Ej2WidgetBase24);

    function ej2Menu(element) {
        _classCallCheck(this, ej2Menu);

        var _this109 = _possibleConstructorReturn(this, _Ej2WidgetBase24.call(this, _ej2Navigations.Menu));
...
exports.ej2Menu = ej2Menu = __decorate([(0, _aureliaTemplating.customElement)(constants.ej2ElementPrefix + 'menu'), (0, _aureliaTemplating.inlineView)("<template><ul></ul></template>"), generateBindables(constants.ej2ElementPrefix + 'Menu', ['animationSettings', 'cssClass', 'enableHtmlSanitizer', 'enablePersistence', 'enableRtl', 'enableScrolling', 'fields', 'filter', 'hamburgerMode', 'items', 'locale', 'orientation', 'showItemOnClick', 'target', 'template', 'title'], [], null, null), (0, _aureliaDependencyInjection.inject)(Element)], ej2Menu);
exports.ej2Menu = ej2Menu;
...
var Ej2MultiSelect = function (_Ej2WidgetBase25) {
    _inherits(Ej2MultiSelect, _Ej2WidgetBase25);

    function Ej2MultiSelect(element) {
        _classCallCheck(this, Ej2MultiSelect);

        var _this110 = _possibleConstructorReturn(this, _Ej2WidgetBase25.call(this, _ej2Dropdowns.MultiSelect));

        _this110.isEditor = true;
        _this110.element = element;
        return _this110;
    }

    return Ej2MultiSelect;
}(Ej2WidgetBase);
exports.Ej2MultiSelect = Ej2MultiSelect = __decorate([(0, _aureliaTemplating.customAttribute)(constants.ej2AttributePrefix + 'multi-select'), generateBindables(constants.ej2ElementPrefix + 'MultiSelect', ['actionFailureTemplate', 'allowCustomValue', 'allowFiltering', 'changeOnBlur', 'closePopupOnSelect', 'cssClass', 'dataSource', 'delimiterChar', 'enableGroupCheckBox', 'enablePersistence', 'enableRtl', 'enableSelectionOrder', 'enabled', 'fields', 'filterBarPlaceholder', 'filterType', 'floatLabelType', 'footerTemplate', 'groupTemplate', 'headerTemplate', 'hideSelectedItem', 'htmlAttributes', 'ignoreAccent', 'ignoreCase', 'itemTemplate', 'locale', 'maximumSelectionLength', 'mode', 'noRecordsTemplate', 'openOnClick', 'placeholder', 'popupHeight', 'popupWidth', 'query', 'readonly', 'selectAllText', 'showClearButton', 'showDropDownIcon', 'showSelectAll', 'sortOrder', 'text', 'unSelectAllText', 'value', 'valueTemplate', 'width', 'zIndex'], ['value'], null, null), (0, _aureliaDependencyInjection.inject)(Element)], Ej2MultiSelect);
...
var Ej2NumericTextBox = function (_Ej2WidgetBase26) {
    _inherits(Ej2NumericTextBox, _Ej2WidgetBase26);

    function Ej2NumericTextBox(element) {
        _classCallCheck(this, Ej2NumericTextBox);

        var _this111 = _possibleConstructorReturn(this, _Ej2WidgetBase26.call(this, _ej2Inputs.NumericTextBox));

        _this111.isEditor = true;
        _this111.element = element;
        return _this111;
    }
...
var ej2Overview = function (_Ej2WidgetBase27) {
    _inherits(ej2Overview, _Ej2WidgetBase27);

    function ej2Overview(element) {
        _classCallCheck(this, ej2Overview);

        var _this112 = _possibleConstructorReturn(this, _Ej2WidgetBase27.call(this, _ej2Diagrams.Overview));

        _this112.element = element;
        return _this112;
    }
...
var ej2PdfViewer = function (_Ej2WidgetBase28) {
    _inherits(ej2PdfViewer, _Ej2WidgetBase28);

    function ej2PdfViewer(element) {
        _classCallCheck(this, ej2PdfViewer);

        var _this113 = _possibleConstructorReturn(this, _Ej2WidgetBase28.call(this, _ej2Pdfviewer.PdfViewer));

        _this113.element = element;
        return _this113;
    }
...
var ej2ProgressButton = function (_Ej2WidgetBase29) {
    _inherits(ej2ProgressButton, _Ej2WidgetBase29);

    function ej2ProgressButton(element) {
        _classCallCheck(this, ej2ProgressButton);

        var _this114 = _possibleConstructorReturn(this, _Ej2WidgetBase29.call(this, _ej2Splitbuttons.ProgressButton));

        _this114.element = element;
        return _this114;
    }

    return ej2ProgressButton;
}(Ej2WidgetBase);
exports.ej2ProgressButton = ej2ProgressButton = __decorate([(0, _aureliaTemplating.customAttribute)(constants.ej2AttributePrefix + 'progress-button'), generateBindables(constants.ej2ElementPrefix + 'ProgressButton', ['animationSettings', 'content', 'cssClass', 'disabled', 'duration', 'enableHtmlSanitizer', 'enableProgress', 'iconCss', 'iconPosition', 'isPrimary', 'isToggle', 'spinSettings'], [], null, null), (0, _aureliaDependencyInjection.inject)(Element)], ej2ProgressButton);
...
var Ej2RadioButton = function (_Ej2WidgetBase30) {
    _inherits(Ej2RadioButton, _Ej2WidgetBase30);

    function Ej2RadioButton(element) {
        _classCallCheck(this, Ej2RadioButton);

        var _this115 = _possibleConstructorReturn(this, _Ej2WidgetBase30.call(this, _ej2Buttons.RadioButton));

        _this115.isEditor = true;
        _this115.element = element;
        return _this115;
    }

    return Ej2RadioButton;
}(Ej2WidgetBase);
exports.Ej2RadioButton = Ej2RadioButton = __decorate([(0, _aureliaTemplating.customAttribute)(constants.ej2AttributePrefix + 'radio-button'), generateBindables(constants.ej2ElementPrefix + 'RadioButton', ['checked', 'cssClass', 'disabled', 'enableHtmlSanitizer', 'enablePersistence', 'enableRtl', 'label', 'labelPosition', 'locale', 'name', 'value'], ['checked'], null, null), (0, _aureliaDependencyInjection.inject)(Element)], Ej2RadioButton);
exports.Ej2RadioButton = Ej2RadioButton;
...
var ej2Rte = function (_Ej2WidgetBase31) {
    _inherits(ej2Rte, _Ej2WidgetBase31);

    function ej2Rte(element) {
        _classCallCheck(this, ej2Rte);

        var _this116 = _possibleConstructorReturn(this, _Ej2WidgetBase31.call(this, _ej2Richtexteditor.RichTextEditor));

        _this116.element = element;
        return _this116;
    }
...
var ej2Sidebar = function (_Ej2WidgetBase33) {
    _inherits(ej2Sidebar, _Ej2WidgetBase33);

    function ej2Sidebar(element) {
        _classCallCheck(this, ej2Sidebar);

        var _this118 = _possibleConstructorReturn(this, _Ej2WidgetBase33.call(this, _ej2Navigations.Sidebar));

        _this118.element = element;
        return _this118;
    }

    return ej2Sidebar;
}(Ej2WidgetBase);
exports.ej2Sidebar = ej2Sidebar = __decorate([(0, _aureliaTemplating.customElement)(constants.ej2ElementPrefix + 'sidebar'), (0, _aureliaTemplating.inlineView)(constants.aureliaTemplateString), generateBindables(constants.ej2ElementPrefix + 'Sidebar', ['animate', 'closeOnDocumentClick', 'dockSize', 'enableDock', 'enableGestures', 'enablePersistence', 'enableRtl', 'height', 'isOpen', 'locale', 'mediaQuery', 'position', 'showBackdrop', 'target', 'type', 'width', 'zIndex'], [], null, null), (0, _aureliaDependencyInjection.inject)(Element)], ej2Sidebar);
...
var Ej2Slider = function (_Ej2WidgetBase34) {
    _inherits(Ej2Slider, _Ej2WidgetBase34);

    function Ej2Slider(element) {
        _classCallCheck(this, Ej2Slider);

        var _this119 = _possibleConstructorReturn(this, _Ej2WidgetBase34.call(this, _ej2Inputs.Slider));

        _this119.isEditor = true;
...
exports.Ej2Slider = Ej2Slider = __decorate([(0, _aureliaTemplating.customElement)(constants.ej2ElementPrefix + 'slider'), (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), generateBindables(constants.ej2ElementPrefix + 'Slider', ['colorRange', 'cssClass', 'customValues', 'enableAnimation', 'enableHtmlSanitizer', 'enablePersistence', 'enableRtl', 'enabled', 'limits', 'locale', 'max', 'min', 'orientation', 'readonly', 'showButtons', 'step', 'ticks', 'tooltip', 'type', 'value'], ['value'], null, null), (0, _aureliaDependencyInjection.inject)(Element)], Ej2Slider);
...
var ej2SplitButton = function (_Ej2WidgetBase35) {
    _inherits(ej2SplitButton, _Ej2WidgetBase35);

    function ej2SplitButton(element) {
        _classCallCheck(this, ej2SplitButton);

        var _this120 = _possibleConstructorReturn(this, _Ej2WidgetBase35.call(this, _ej2Splitbuttons.SplitButton));

        _this120.element = element;
        return _this120;
    }

    return ej2SplitButton;
}(Ej2WidgetBase);
exports.ej2SplitButton = ej2SplitButton = __decorate([(0, _aureliaTemplating.customElement)(constants.ej2AttributePrefix + 'split-button'), (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), generateBindables(constants.ej2ElementPrefix + 'SplitButton', ['content', 'cssClass', 'disabled', 'enableHtmlSanitizer', 'enablePersistence', 'enableRtl', 'iconCss', 'iconPosition', 'items', 'locale', 'target'], [], null, null), (0, _aureliaDependencyInjection.inject)(Element)], ej2SplitButton);
...
var Ej2Splitter = function (_Ej2WidgetBase36) {
    _inherits(Ej2Splitter, _Ej2WidgetBase36);

    function Ej2Splitter(element) {
        _classCallCheck(this, Ej2Splitter);

        var _this121 = _possibleConstructorReturn(this, _Ej2WidgetBase36.call(this, _ej2Layouts.Splitter));

        _this121.element = element;
        return _this121;
    }

    return Ej2Splitter;
}(Ej2WidgetBase);
exports.Ej2Splitter = Ej2Splitter = __decorate([(0, _aureliaTemplating.customElement)(constants.ej2ElementPrefix + 'splitter'), (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), generateBindables(constants.ej2ElementPrefix + 'Splitter', ['cssClass', 'enableHtmlSanitizer', 'enablePersistence', 'enableRtl', 'enabled', 'height', 'locale', 'orientation', 'paneSettings', 'separatorSize', 'width'], [], null, null), (0, _aureliaDependencyInjection.inject)(Element)], Ej2Splitter);
...
var Ej2Switch = function (_Ej2WidgetBase37) {
    _inherits(Ej2Switch, _Ej2WidgetBase37);

    function Ej2Switch(element) {
        _classCallCheck(this, Ej2Switch);

        var _this122 = _possibleConstructorReturn(this, _Ej2WidgetBase37.call(this, _ej2Buttons.Switch));

        _this122.isEditor = true;
        _this122.element = element;
        return _this122;
    }

    return Ej2Switch;
}(Ej2WidgetBase);
exports.Ej2Switch = Ej2Switch = __decorate([(0, _aureliaTemplating.customElement)(constants.ej2ElementPrefix + 'switch'), (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), generateBindables(constants.ej2ElementPrefix + 'Switch', ['checked', 'cssClass', 'disabled', 'enablePersistence', 'enableRtl', 'locale', 'name', 'offLabel', 'onLabel', 'value'], ['checked'], null, null), (0, _aureliaDependencyInjection.inject)(Element)], Ej2Switch);
...
var ej2Tab = function (_Ej2WidgetBase38) {
    _inherits(ej2Tab, _Ej2WidgetBase38);

    function ej2Tab(element) {
        _classCallCheck(this, ej2Tab);

        var _this123 = _possibleConstructorReturn(this, _Ej2WidgetBase38.call(this, _ej2Navigations.Tab));

        _this123.element = element;
        return _this123;
    }
...
var Ej2TextBox = function (_Ej2WidgetBase39) {
    _inherits(Ej2TextBox, _Ej2WidgetBase39);

    function Ej2TextBox(element) {
        _classCallCheck(this, Ej2TextBox);

        var _this124 = _possibleConstructorReturn(this, _Ej2WidgetBase39.call(this, _ej2Inputs.TextBox));

        _this124.isEditor = true;
        _this124.element = element;
        return _this124;
    }

    return Ej2TextBox;
}(Ej2WidgetBase);
exports.Ej2TextBox = Ej2TextBox = __decorate([(0, _aureliaTemplating.customAttribute)(constants.ej2AttributePrefix + 'text-box'), generateBindables(constants.ej2ElementPrefix + 'TextBox', ['autocomplete', 'cssClass', 'enablePersistence', 'enableRtl', 'enabled', 'floatLabelType', 'htmlAttributes', 'locale', 'multiline', 'placeholder', 'readonly', 'showClearButton', 'type', 'value', 'width'], ['value'], null, null), (0, _aureliaDependencyInjection.inject)(Element)], Ej2TextBox);
...
var Ej2TimePicker = function (_Ej2WidgetBase40) {
    _inherits(Ej2TimePicker, _Ej2WidgetBase40);

    function Ej2TimePicker(element) {
        _classCallCheck(this, Ej2TimePicker);

        var _this125 = _possibleConstructorReturn(this, _Ej2WidgetBase40.call(this, _ej2Calendars.TimePicker));

        _this125.isEditor = true;
        _this125.element = element;
        return _this125;
    }

    return Ej2TimePicker;
}(Ej2WidgetBase);
exports.Ej2TimePicker = Ej2TimePicker = __decorate([(0, _aureliaTemplating.customAttribute)(constants.ej2AttributePrefix + 'time-picker'), generateBindables(constants.ej2ElementPrefix + 'TimePicker', ['allowEdit', 'cssClass', 'enablePersistence', 'enableRtl', 'enabled', 'floatLabelType', 'format', 'htmlAttributes', 'keyConfigs', 'locale', 'max', 'min', 'placeholder', 'readonly', 'scrollTo', 'showClearButton', 'step', 'strictMode', 'value', 'width', 'zIndex'], ['value'], null, null), (0, _aureliaDependencyInjection.inject)(Element)], Ej2TimePicker);
...
var ej2Toast = function (_Ej2WidgetBase41) {
    _inherits(ej2Toast, _Ej2WidgetBase41);

    function ej2Toast(element) {
        _classCallCheck(this, ej2Toast);

        var _this126 = _possibleConstructorReturn(this, _Ej2WidgetBase41.call(this, _ej2Notifications.Toast));

        _this126.element = element;
        return _this126;
    }

    return ej2Toast;
}(Ej2WidgetBase);
exports.ej2Toast = ej2Toast = __decorate([(0, _aureliaTemplating.customElement)(constants.ej2ElementPrefix + 'toast'), (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), generateBindables(constants.ej2ElementPrefix + 'Toast', ['animation', 'buttons', 'content', 'cssClass', 'enableHtmlSanitizer', 'enablePersistence', 'enableRtl', 'extendedTimeout', 'height', 'icon', 'locale', 'newestOnTop', 'position', 'showCloseButton', 'showProgressBar', 'target', 'template', 'timeOut', 'title', 'width'], null, null, null), (0, _aureliaDependencyInjection.inject)(Element)], ej2Toast);
exports.ej2Toast = ej2Toast;
...
exports.Ej2Items = Ej2Items = __decorate([(0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), (0, _aureliaTemplating.customElement)('e-item'), generateBindables('items', ['align', 'cssClass', 'disabled', 'htmlAttributes', 'id', 'overflow', 'prefixIcon', 'showAlwaysInPopup', 'showTextOn', 'suffixIcon', 'template', 'text', 'tooltipText', 'type', 'visible', 'width'], [], null, null)], Ej2Items);
...
var Ej2Toolbar = function (_Ej2WidgetBase42) {
    _inherits(Ej2Toolbar, _Ej2WidgetBase42);

    function Ej2Toolbar(element) {
        _classCallCheck(this, Ej2Toolbar);

        var _this127 = _possibleConstructorReturn(this, _Ej2WidgetBase42.call(this, _ej2Navigations.Toolbar));

        _this127.items = [];
        _this127.element = element;
        _this127.hasChildProperty = true;
        _this127.childPropertyName = 'items';
        return _this127;
    }

    return Ej2Toolbar;
}(Ej2WidgetBase);
__decorate([(0, _aureliaTemplating.children)('e-items')], Ej2Toolbar.prototype, "items", void 0);
exports.Ej2Toolbar = Ej2Toolbar = __decorate([(0, _aureliaTemplating.customElement)(constants.ej2ElementPrefix + 'toolbar'), (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), generateBindables(constants.ej2ElementPrefix + 'Toolbar', ['cssClass', 'enableCollision', 'enableHtmlSanitizer', 'enablePersistence', 'enableRtl', 'height', 'items', 'locale', 'overflowMode', 'scrollStep', 'width'], [], null, null), (0, _aureliaDependencyInjection.inject)(Element)], Ej2Toolbar);
...
var ej2Tooltip = function (_Ej2WidgetBase43) {
    _inherits(ej2Tooltip, _Ej2WidgetBase43);

    function ej2Tooltip(element) {
        _classCallCheck(this, ej2Tooltip);

        var _this128 = _possibleConstructorReturn(this, _Ej2WidgetBase43.call(this, _ej2Popups.Tooltip));

        _this128.element = element;
        return _this128;
    }

    return ej2Tooltip;
}(Ej2WidgetBase);
exports.ej2Tooltip = ej2Tooltip = __decorate([(0, _aureliaTemplating.customElement)(constants.ej2ElementPrefix + 'tooltip'), (0, _aureliaTemplating.inlineView)('' + constants.aureliaTemplateString), generateBindables(constants.ej2ElementPrefix + 'Tooltip', ['animation', 'closeDelay', 'content', 'cssClass', 'enableHtmlSanitizer', 'enablePersistence', 'enableRtl', 'height', 'isSticky', 'locale', 'mouseTrail', 'offsetX', 'offsetY', 'openDelay', 'opensOn', 'position', 'showTipPointer', 'target', 'tipPointerPosition', 'width'], [], [], null), (0, _aureliaDependencyInjection.inject)(Element)], ej2Tooltip);
...
var Ej2Uploader = function (_Ej2WidgetBase44) {
    _inherits(Ej2Uploader, _Ej2WidgetBase44);

    function Ej2Uploader(element) {
        _classCallCheck(this, Ej2Uploader);

        var _this129 = _possibleConstructorReturn(this, _Ej2WidgetBase44.call(this, _ej2Inputs.Uploader));

        _this129.isEditor = true;
        _this129.element = element;
        return _this129;
    }

    return Ej2Uploader;
}(Ej2WidgetBase);
exports.Ej2Uploader = Ej2Uploader = __decorate([(0, _aureliaTemplating.customAttribute)(constants.ej2AttributePrefix + 'uploader'), generateBindables(constants.ej2ElementPrefix + 'Uploader', ['allowedExtensions', 'asyncSettings', 'autoUpload', 'buttons', 'cssClass', 'directoryUpload', 'dropArea', 'enablePersistence', 'enableRtl', 'enabled', 'files', 'htmlAttributes', 'locale', 'maxFileSize', 'minFileSize', 'multiple', 'sequentialUpload', 'showFileList', 'template'], [], null, null), (0, _aureliaDependencyInjection.inject)(Element)], Ej2Uploader);
