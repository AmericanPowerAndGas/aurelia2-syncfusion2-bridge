define(["exports", "../common/widget-base", "../common/constants", "../common/decorators", "../common/common"], function (exports, _widgetBase, _constants, _decorators, _common) {
    ...
    exports.ejRating = ejRating = __decorate([(0, _common.customAttribute)(_constants.constants.attributePrefix + "rating"), (0, _decorators.generateBindables)('ejRating', ['allowReset', 'cssClass', 'enabled', 'enablePersistence', 'height', 'htmlAttributes', 'incrementStep', 'maxValue', 'minValue', 'orientation', 'precision', 'readOnly', 'shapeHeight', 'shapeWidth', 'showTooltip', 'value', 'width'], ['value']), (0, _common.inject)(Element)], ejRating);
