define(["exports", "../common/widget-base", "../common/constants", "../common/decorators", "../common/common"], function (exports, _widgetBase, _constants, _decorators, _common) {
    ...
    exports.ejGroupButton = ejGroupButton = __decorate([(0, _common.customAttribute)(_constants.constants.attributePrefix + "group-button"), (0, _decorators.generateBindables)('ejGroupButton', ['cssClass', 'dataSource', 'enableRTL', 'enabled', 'fields', 'groupButtonMode', 'height', 'htmlAttributes', 'orientation', 'query', 'selectedItemIndex', 'showRoundedCorner', 'size', 'width'], [], { 'enableRTL': ['enableRtl'] }), (0, _common.inject)(Element)], ejGroupButton);
