define(["exports", "../../common/ej2-widget-base", "../../common/constants", "../../common/decorators", "../../common/common", "@syncfusion/ej2-calendars"], function (exports, _ej2WidgetBase, _constants, _decorators, _common, _ej2Calendars) {
    ...
    exports.ej2DateRangePicker = undefined;
    ...
    var ej2DateRangePicker = function (_Ej2WidgetBase) {
        _inherits(ej2DateRangePicker, _Ej2WidgetBase);

        function ej2DateRangePicker(element) {
            _classCallCheck(this, ej2DateRangePicker);

            var _this = _possibleConstructorReturn(this, _Ej2WidgetBase.call(this, _ej2Calendars.DateRangePicker));
