define(["exports", "../common/widget-base", "../common/constants", "../common/decorators", "../common/common"], function (exports, _widgetBase, _constants, _decorators, _common) {
    ...
    exports.ejOverview = ejOverview = __decorate([(0, _common.customElement)(_constants.constants.elementPrefix + "overview"), (0, _common.inlineView)("" + _constants.constants.aureliaTemplateString), (0, _decorators.generateBindables)('ejOverview', ['sourceID', 'height', 'width'], [], { 'sourceID': ['sourceId'] }), (0, _common.inject)(Element)], ejOverview);
