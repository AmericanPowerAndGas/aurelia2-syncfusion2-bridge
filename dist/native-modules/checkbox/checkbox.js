...
enableRipple(true);
export const inputs = ['checked', 'cssClass', 'disabled', 'enablePersistence', 'enableRtl', 'htmlAttributes', 'indeterminate', 'label', 'labelPosition', 'locale', 'name', 'value'];
export const twoWays = ['checked', 'indeterminate'];
let CheckBoxComponent = class CheckBoxComponent extends CheckBox {
    constructor(element) {
        super();
