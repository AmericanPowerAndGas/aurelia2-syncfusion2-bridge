...
System.register(["aurelia-dependency-injection", "../common/util", "aurelia-templating"], function (_export, _context) {
    ...
    var inject, Util, TemplatingEngine, _typeof, __decorate, TemplateProcessor;
    ...
    return {
        ...
        execute: function () {
            ...
            _export("TemplateProcessor", TemplateProcessor = function () {
            ...
            _export("TemplateProcessor", TemplateProcessor = __decorate([inject(TemplatingEngine, Util)], TemplateProcessor));
