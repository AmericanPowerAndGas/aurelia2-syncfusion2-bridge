...
System.register(["../common/widget-base", "../common/constants", "../common/decorators", "../common/common"], function (_export, _context) {
    ...
    var WidgetBase, constants, generateBindables, customAttribute, inject, _typeof, __decorate, ejMenu;
    ...
    return {
        ...
        execute: function () {
            ...
            _export("ejMenu", ejMenu = function (_WidgetBase) {
            ...
            _export("ejMenu", ejMenu = __decorate([customAttribute(constants.attributePrefix + "menu"), generateBindables('ejMenu', ['animationType', 'contextMenuTarget', 'container', 'cssClass', 'enableAnimation', 'enableCenterAlign', 'enabled', 'enableRTL', 'enableSeparator', 'excludeTarget', 'fields', 'height', 'htmlAttributes', 'isResponsive', 'menuType', 'openOnClick', 'orientation', 'showRootLevelArrows', 'showSubLevelArrows', 'subMenuDirection', 'titleText', 'width', 'overflowHeight', 'overflowWidth'], [], { 'enableRTL': ['enableRtl'] }), inject(Element)], ejMenu));
