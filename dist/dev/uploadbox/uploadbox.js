...
System.register(["../common/widget-base", "../common/constants", "../common/decorators", "../common/common"], function (_export, _context) {
    ...
    var WidgetBase, constants, generateBindables, customElement, inlineView, inject, _typeof, __decorate, ejUploadbox;
    ...
    return {
        ...
        execute: function () {
            ...
            _export("ejUploadbox", ejUploadbox = function (_WidgetBase) {
