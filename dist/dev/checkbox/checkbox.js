...
System.register(["../common/widget-base", "../common/constants", "../common/decorators", "../common/common"], function (_export, _context) {
    ...
    var WidgetBase, constants, generateBindables, customAttribute, inject, _typeof, __decorate, ejCheckBox;
    ...
    return {
        ...
        execute: function () {
            ...
            _export("ejCheckBox", ejCheckBox = function (_WidgetBase) {
            ...
            _export("ejCheckBox", ejCheckBox = __decorate([customAttribute(constants.attributePrefix + "check-box"), generateBindables('ejCheckBox', ['checked', 'checkState', 'cssClass', 'enabled', 'enablePersistence', 'enableRTL', 'enableTriState', 'htmlAttributes', 'id', 'idPrefix', 'name', 'showRoundedCorner', 'size', 'text', 'validationMessage', 'validationRules', 'value'], ['checked', 'checkState'], { 'enableRTL': ['enableRtl'] }), inject(Element)], ejCheckBox));
