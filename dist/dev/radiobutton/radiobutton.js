...
System.register(["../common/widget-base", "../common/constants", "../common/decorators", "../common/common"], function (_export, _context) {
    ...
    var WidgetBase, constants, generateBindables, customAttribute, inject, _typeof, __decorate, ejRadioButton;
    ...
    return {
        ...
        execute: function () {
            ...
            _export("ejRadioButton", ejRadioButton = function (_WidgetBase) {
            ...
            _export("ejRadioButton", ejRadioButton = __decorate([customAttribute(constants.attributePrefix + "radio-button"), generateBindables('ejRadioButton', ['checked', 'cssClass', 'enabled', 'enablePersistence', 'enableRTL', 'htmlAttributes', 'id', 'idPrefix', 'name', 'size', 'text', 'validationMessage', 'validationRules', 'value'], [], { 'enableRTL': ['enableRtl'] }), inject(Element)], ejRadioButton));

            _export("ejRadioButton", ejRadioButton);
        }
    };
});
//# sourceMappingURL=../devbuild/dev/radiobutton/radiobutton.js.map
