...
System.register(["../common/widget-base", "../common/constants", "../common/decorators", "../common/common"], function (_export, _context) {
    ...
    var WidgetBase, constants, generateBindables, customElement, inlineView, inject, _typeof, __decorate, ejCircularGauge;
    ...
    return {
        ...
        execute: function () {
            ...
            _export("ejCircularGauge", ejCircularGauge = function (_WidgetBase) {
