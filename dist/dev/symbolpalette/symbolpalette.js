...
System.register(["../common/widget-base", "../common/constants", "../common/decorators", "../common/common"], function (_export, _context) {
    ...
    var WidgetBase, constants, generateBindables, customElement, inlineView, inject, _typeof, __decorate, ejSymbolPalette;
    ...
    return {
        ...
        execute: function () {
            ...
            _export("ejSymbolPalette", ejSymbolPalette = function (_WidgetBase) {
            ...
            _export("ejSymbolPalette", ejSymbolPalette = __decorate([customElement(constants.elementPrefix + "symbol-palette"), inlineView("" + constants.aureliaTemplateString), generateBindables('ejSymbolPalette', ['allowDrag', 'cssClass', 'defaultSettings', 'diagramId', 'headerHeight', 'height', 'paletteItemHeight', 'paletteItemWidth', 'palettes', 'previewHeight', 'previewOffset', 'previewWidth', 'showPaletteItemText', 'width']), inject(Element)], ejSymbolPalette));

            _export("ejSymbolPalette", ejSymbolPalette);
        }
    };
});
//# sourceMappingURL=../devbuild/dev/symbolpalette/symbolpalette.js.map
