...
System.register(["../common/widget-base", "../common/constants", "../common/decorators", "../common/common"], function (_export, _context) {
    ...
    var WidgetBase, constants, generateBindables, customElement, inlineView, inject, _typeof, __decorate, ejPdfViewer;
    ...
    return {
        ...
        execute: function () {
            ...
            _export("ejPdfViewer", ejPdfViewer = function (_WidgetBase) {
