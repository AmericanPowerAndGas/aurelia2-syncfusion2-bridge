...
exports.ejMaskEdit = ejMaskEdit = __decorate([(0, _common.customAttribute)(_constants.constants.attributePrefix + "mask-edit"), (0, _decorators.generateBindables)('ejMaskEdit', ['cssClass', 'customCharacter', 'enabled', 'enablePersistence', 'height', 'hidePromptOnLeave', 'htmlAttributes', 'inputMode', 'locale', 'maskFormat', 'name', 'readOnly', 'showError', 'showPromptChar', 'showRoundedCorner', 'textAlign', 'validationMessage', 'validationRules', 'value', 'watermarkText', 'width'], ['value']), (0, _common.inject)(Element)], ejMaskEdit);
exports.ejMaskEdit = ejMaskEdit;