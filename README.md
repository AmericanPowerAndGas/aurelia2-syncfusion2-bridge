...
```shell
npm i github:your_github_username/aurelia-syncfusion-bridge
# or if you use bitbucket
npm i bitbucket:your_github_username/aurelia-syncfusion-bridge
# or if you use gitlab
npm i gitlab:your_github_username/aurelia-syncfusion-bridge
# or plain url
npm i https:/github.com/your_github_username/aurelia-syncfusion-bridge.git
```
